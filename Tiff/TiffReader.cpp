...
struct TiffReaderData {
    ...
    int sampleCode =0;
    zeroth::SampleFormat currentSampleFormat;
    ...
    void setCurrentFormat() {
        switch (sampleCode) {
        case 8:{
            currentSampleFormat = zeroth::UINT8;
            break;
        }
        case 10:{
            currentSampleFormat = zeroth::INT8;
            break;
        }
        case 16:{
            currentSampleFormat = zeroth::UINT16;
            break;
        }
        case 18:{
            currentSampleFormat = zeroth::INT16;
            break;
        }
        case 32:{
            currentSampleFormat = zeroth::UINT32;
            break;
        }
        case 34:{
            currentSampleFormat = zeroth::INT32;
            break;
        }
        case 36:{
            currentSampleFormat = zeroth::FLOAT;
            break;
        }
...
zeroth::SampleFormat TiffReader::dataType() const
{
    return d->currentSampleFormat;
}
